...
**💡 What this does:** Creates your own copy of this template repository with all the website, bot, and deployment automation files. This becomes your project's home where all code changes trigger automatic deployments.

### **Option A: Use as Template (Recommended)**

1.  Go to this repository on GitHub: `https://github.com/YOUR-USERNAME/azure-qnabot-website`
2.  Click the **Use this template** button (green button at the top)
3.  Click **Create a new repository**
4.  Fill in:
    - Owner: Your GitHub username
    - Repository name: `azure-qna-chatbot` (or your preferred name)
    - Visibility: **Public** (recommended for class exercises) or **Private**
...
4.  Optionally rename the repository to `azure-qna-chatbot`
5.  Click **Create fork**

Your new repository now contains:
...
**Next:** Clone your new repository to your local machine if you want to make changes locally, or proceed directly to Step 2 to start creating Azure resources.
